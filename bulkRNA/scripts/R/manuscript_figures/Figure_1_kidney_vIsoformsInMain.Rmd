...
upFoldChange <-
  treatment_vs_control[treatment_vs_control$logFC > 6,]
upFoldChange <- upFoldChange[5:35, ]
...
goi <- 
  treatment_vs_control[treatment_vs_control$gene_name == "NCOA7",]
goi2 <- 
  treatment_vs_control[treatment_vs_control$gene_name == "HSPH1",]
...
GO_5 <-
  subset(up_df,
         up_df$variable == "Network map of SARS-CoV-2 signaling pathway"
         & up_df$value == 1)
...
down_input <- list(
  ...
  "morphogenesis of an epithelium" = down_gene_char[[14]]
)
...
GO_5 <-
  subset(down_df,
         down_df$variable == "morphogenesis of an epithelium"
         & down_df$value == 1)
GO_5_top <- head(GO_5, 15)
```
#### plot lcpm GO heatmaps
