...
## up 
 ...
 [7] "hematopoietic or lymphoid organ development"            
 [8] "regulation of cell adhesion"                            
 [9] "positive regulation of cell migration"                  
[10] "Network map of SARS-CoV-2 signaling pathway"            
[11] "vasculature development"                                
[12] "regulation of angiogenesis"                             
[13] "response to tumor necrosis factor"                      
[14] "VEGFA-VEGFR2 signaling pathway"                         
[15] "regulation of DNA-binding transcription factor activity"
```{r}
up_enrich_df <-
...
up_input <- list(
  ...
  "positive regulation of cell death" = up_gene_char[[6]],
  "positive regulation of cell migration" = up_gene_char[[9]],
  "vasculature development" = up_gene_char[[11]],
  "regulation of DNA-binding transcription factor activity" = up_gene_char[[15]] 
)
...
## down
 ...
 [9] "tight junction assembly"                      
[10] "Hematopoietic stem cell differentiation"      
[11] "blood vessel endothelial cell migration"      
[12] "Nuclear receptors meta-pathway"               
[13] "positive regulation of angiogenesis"          
[14] "morphogenesis of an epithelium"               
[15] "regulation of binding" 
```{r}
down_enrich_df <-
...
down_input <- list(
  ...
  "tight junction assembly" = down_gene_char[[9]], 
  "blood vessel endothelial cell migration" = down_gene_char[[11]],
  "positive regulation of angiogenesis" = down_gene_char[[13]]
)
...
df <- as.data.frame(data_tpm_reorder)
df$target_id <- rownames(df)
test_1007 <- subset(df, target_id == "ENSSSCT00000091007.2")
test_1007$target_id <- NULL
log2(test_1007)
...
data_summary <- function(data, varname, groupnames) {
  ...
  tmp_per_target <-
    get_bootstrap_summary(so, target_id = "ENSSSCT00000091007.2", units = "est_counts")
...
plot_bootstrap(so, target_id = "ENSSSCT00000091007.2")
```
